...
//	}
    ...
    public void onCreate(Bundle bund) {
        ...
        bback = findViewById(R.id.bprevious);
        bback.setOnClickListener(this);
        bhint = findViewById(R.id.bhint);
        ...
        tvbestLabel = findViewById(R.id.tvbestLabel);
        ...
        screenHeight = DataHandler.getDevice_height() - 200;
        ...
        initSounds();
        currentStars = 0;
        absLayout = findViewById(R.id.mainGameLayout);
...
//		}
    ...
    private void setupDialog(Dialog dialog) {
        ...
        TextView tvCurrentStep = dialog.findViewById(R.id.text);
        ...
        TextView tvBestStep = dialog.findViewById(R.id.text2);
        ...
        Button bdialogMenu = dialog.findViewById(R.id.bdialogMenu);
        bdialogMenu.setOnClickListener(this);

        Button bdialogReplay = dialog.findViewById(R.id.bdialogReplay);
        bdialogReplay.setOnClickListener(this);

        Button bdialogNext = dialog.findViewById(R.id.bdialogNext);
        bdialogNext.setOnClickListener(this);

        Button bshare = dialog.findViewById(R.id.bshare);
...
//			showInterstitalAds();
            ...
            if (packName.compareToIgnoreCase(pack) == 0) {
                if (value == 1) {
                    if (puzzleID < levelManager.getNumberOfPacks(packName)) {
                        ...
                        puzzleID = 1;
                        packName = list.get((i + 1) % list.size());
                    }
                } else if (value == -1) {
                    if (puzzleID > 1) {
                        puzzleID += -1;
                    } else {
                        packName = list.get((i - 1 + list.size()) % list.size());
    ...
    public void playsoundbyid(int value) {
        if (PrefClass.getSound()) {
            ...
            int soundMap = mSoundPoolMap.get(Integer.valueOf(value)).intValue();
    ...
    public void setRateStar(int value, Dialog dialog) {
        ImageView[] imgViewArr = new ImageView[]{dialog.findViewById(R.id.ratingview1),
                dialog.findViewById(R.id.ratingview2), dialog.findViewById(R.id.ratingview3)};
