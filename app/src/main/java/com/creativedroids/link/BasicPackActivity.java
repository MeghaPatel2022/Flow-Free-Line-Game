...
public class BasicPackActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvselectPack = findViewById(R.id.tvSelectPack);
        tvselectPack.setTypeface(DataHandler.getTypeface(context));

        bpack5 = findViewById(R.id.bpack5);
        bpack6 = findViewById(R.id.bpack6);
        bpack7 = findViewById(R.id.bpack7);
        bpack8 = findViewById(R.id.bpack8);
        bpack9 = findViewById(R.id.bpack9);
        bpack10 = findViewById(R.id.bpack10);
