...
import com.creativedroids.link.utils.BlankView;
import com.creativedroids.link.utils.DataHandler;
import com.creativedroids.link.utils.LevelButton;
...
public class LevelsActivity extends Activity {
    ...
    public void onCreate(Bundle instanceSavedState) {
        ...
        tvleveldetails = findViewById(R.id.tvleveldetails);
        tvstardetails = findViewById(R.id.tvstardetails);
        ...
        if (packName.contentEquals("5x5") || packName.contentEquals("a5x5")) {
            ...
            draw = context.getResources().getDrawable(
        ...
        setButtonsAndStars();
        resumable = true;
        tvleveldetails.setText(levelsCompleted + "/"
                + totalLevels);
        tvstardetails.setText(totalStarsFound + "/"
                + totalLevels * 3);
    }
    ...
    private void setButtonsAndStars() {
        ...
        for (int i = 0; i < levelList.size() / 5; i++) {
            ...
            for (int j = 0; j < 5; j++) {
                ...
                levelsData = levelList.get(i * 5 + j).split("=");
